...
public class Plateau implements Cloneable{
    ...
    {
        return board[((8-ligne)*8)+colonne];
    }
    ...
    public int[] deplacerDansBoard(int ligneDepart, int colonneDepart, int ligneArrivee, int colonneArrivee)
    {
        ...
        boardAModifier[((8-ligneArrivee)*8) + colonneArrivee]=boardAModifier[((8-ligneArrivee)*8) + colonneArrivee];
        boardAModifier[((8-ligneDepart)*8) + colonneDepart] = 0;
